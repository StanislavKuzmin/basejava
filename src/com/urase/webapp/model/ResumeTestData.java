...
public class ResumeTestData {
    ...
    public static void main(String[] args) {
        ...
        ListSimpleSection achivement = new ListSimpleSection();
        achivement.addTextToList("Организация команды и успешная реализация Java проектов для сторонних заказчиков: приложения автопарк на стеке Spring Cloud/микросервисы, система мониторинга показателей спортсменов на Spring Boot, участие в проекте МЭШ на Play-2, многомодульный Spring Boot + Vaadin проект для комплексных DIY смет");
        achivement.addTextToList("С 2013 года: разработка проектов \"Разработка Web приложения\",\"Java Enterprise\", \"Многомодульный maven. Многопоточность. XML (JAXB/StAX). Веб сервисы (JAX-RS/SOAP). Удаленное взаимодействие (JMS/AKKA)\". Организация онлайн стажировок и ведение проектов. Более 3500 выпускников");
        resume.saveSection(ACHIEVEMENT, achivement);
        ...
        Education education_1 = new Education();
        education_1.setStartDate(LocalDate.of(2013, 3, 1));
        education_1.setEndDate(LocalDate.of(2013, 5, 1));
        education_1.setEducationalOrganization("Coursera");
        education_1.setEducationDescription("Functional Programming Principles in Scala' by Martin Odersky");
        Education education_2 = new Education();
        education_2.setStartDate(LocalDate.of(2011, 3, 1));
        education_2.setEndDate(LocalDate.of(2011, 4, 1));
        education_2.setEducationalOrganization("Luxoft");
        education_2.setEducationDescription("Курс 'Объектно-ориентированный анализ ИС. Концептуальное моделирование на UML.");
        Organization<Education> listEducation = new Organization<>();
