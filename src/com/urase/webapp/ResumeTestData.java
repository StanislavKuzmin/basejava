...
public class ResumeTestData {
    ...
    private void initializeExperience(Resume resume) {
        Organization organization_1 = new Organization(LocalDate.of(2013, 10, 1), LocalDate.now(), "https://javaops.ru/",
                "Создание, организация и проведение Java онлайн проектов и стажировок.", "Автор проекта");
        Organization organization_2 = new Organization(LocalDate.of(2014, 10, 1), LocalDate.of(2016, 1, 1),
                "https://www.wrike.com/", "Проектирование и разработка онлайн платформы управления проектами Wrike (Java 8 API," +
    ...
    private void initializeEducation(Resume resume) {
        ...
        Organization education_1 = new Organization(null, null,
                "Санкт-Петербургский национальный исследовательский университет информационных технологий, механики и оптики", null, null);
